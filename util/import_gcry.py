...
for cipher_file in cipher_files:
    ...
    if re.match ("(Manifest|Makefile\.am|ac\.c|cipher\.c|hmac-tests\.c|md\.c|pubkey\.c|gostr3411-94.c|stribog.c)$", cipher_file) or cipher_file == "kdf.c" or cipher_file == "elgamal.c" or cipher_file == "primegen.c" or cipher_file == "ecc.c" or cipher_file == "test-getrusage.c" or cipher_file == "salsa20.c":
        chlog = "%s%s: Removed\n" % (chlog, chlognew)
        continue
    ...
    if re.match (".*\.[ch]$", cipher_file):
        ...
        continue
    chlog = "%s%s Skipped unknown file\n" % (chlog, chlognew)
